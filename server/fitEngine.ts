...
export const BRAND_WEIGHT_TABLE: Record<string, BrandWeights> = {
  // ── TRUST BRANDS ─────────────────────────────────────────────────────────
  // Medical / Health
  "Medical — General Practice / Clinic":        { alpha: 0.6, beta: 0.2, gamma: 0.2, priority: "Trust + safety",              brandArchetype: "Trust" },
  "Medical — Aesthetics / MedSpa":              { alpha: 0.6, beta: 0.2, gamma: 0.2, priority: "Aspiration + trust",           brandArchetype: "Trust" },
  "Medical — Chiropractic / PT / Allied Health":{ alpha: 0.6, beta: 0.2, gamma: 0.2, priority: "Authority + lifestyle fit",    brandArchetype: "Trust" },
  "Medical — Dental / Orthodontics":            { alpha: 0.6, beta: 0.2, gamma: 0.2, priority: "Trust + safety",              brandArchetype: "Trust" },
  "Medical — Optometry / Vision Care":          { alpha: 0.6, beta: 0.2, gamma: 0.2, priority: "Trust + safety",              brandArchetype: "Trust" },
  "Medical — Pharmacy / Health Retail":         { alpha: 0.6, beta: 0.2, gamma: 0.2, priority: "Trust + accessibility",       brandArchetype: "Trust" },
  "Mental Health — Private Practice / App":     { alpha: 0.6, beta: 0.2, gamma: 0.2, priority: "Trust + consistency",         brandArchetype: "Trust" },
  "Mental Health — Wellness Platform":          { alpha: 0.6, beta: 0.2, gamma: 0.2, priority: "Trust + community",           brandArchetype: "Trust" },
  // Legal Services
  "Legal — Personal Injury / Consumer Law":     { alpha: 0.6, beta: 0.2, gamma: 0.2, priority: "Authority + trust",           brandArchetype: "Trust" },
  "Legal — Corporate / Commercial Law":         { alpha: 0.6, beta: 0.2, gamma: 0.2, priority: "Trust + stability",           brandArchetype: "Trust" },
  "Legal — Family Law":                         { alpha: 0.6, beta: 0.2, gamma: 0.2, priority: "Trust + safety",              brandArchetype: "Trust" },
  "Legal — Immigration Law":                    { alpha: 0.6, beta: 0.2, gamma: 0.2, priority: "Trust + community",           brandArchetype: "Trust" },
  "Legal — Criminal Defence":                   { alpha: 0.6, beta: 0.2, gamma: 0.2, priority: "Authority + trust",           brandArchetype: "Trust" },
  // Financial Services
  "Financial — Personal Finance / Budgeting":   { alpha: 0.6, beta: 0.2, gamma: 0.2, priority: "Value alignment",             brandArchetype: "Trust" },
  "Financial — Local Accounting / Tax":         { alpha: 0.6, beta: 0.2, gamma: 0.2, priority: "Trust + stability",           brandArchetype: "Trust" },
  "Financial — Wealth Management / Investment": { alpha: 0.6, beta: 0.2, gamma: 0.2, priority: "Trust + safety",              brandArchetype: "Trust" },
  "Financial — Mortgage / Lending":             { alpha: 0.6, beta: 0.2, gamma: 0.2, priority: "Trust + aspiration",          brandArchetype: "Trust" },
  "Financial — Fintech / Banking App":          { alpha: 0.6, beta: 0.2, gamma: 0.2, priority: "Trust + innovation",          brandArchetype: "Trust" },
  // Insurance
  "Insurance — Local Broker":                   { alpha: 0.6, beta: 0.2, gamma: 0.2, priority: "Trust + safety",              brandArchetype: "Trust" },
  "Insurance — Life / Health Insurance":        { alpha: 0.6, beta: 0.2, gamma: 0.2, priority: "Trust + safety",              brandArchetype: "Trust" },
  "Insurance — Auto / Home Insurance":          { alpha: 0.6, beta: 0.2, gamma: 0.2, priority: "Trust + reliability",         brandArchetype: "Trust" },
  // Home Renovation / Construction
  "Home — Renovation / Contracting":            { alpha: 0.5, beta: 0.3, gamma: 0.2, priority: "Credibility + safety",        brandArchetype: "Trust" },
  "Home — Architecture / Interior Design Firm": { alpha: 0.5, beta: 0.3, gamma: 0.2, priority: "Aesthetic authority",         brandArchetype: "Trust" },
  // Children's & Family
  "Family — Children's Products":               { alpha: 0.5, beta: 0.3, gamma: 0.2, priority: "Safety + value alignment",    brandArchetype: "Trust" },
  "Family — Baby / Infant Care":                { alpha: 0.6, beta: 0.2, gamma: 0.2, priority: "Trust + safety",              brandArchetype: "Trust" },
  "Family — Parenting / Education Platform":    { alpha: 0.5, beta: 0.3, gamma: 0.2, priority: "Trust + community",           brandArchetype: "Trust" },
  // Education (Trust-leaning)
  "Education — Local Tutoring / School":        { alpha: 0.5, beta: 0.3, gamma: 0.2, priority: "Trust + stability",           brandArchetype: "Trust" },
  "Education — University / College":           { alpha: 0.5, beta: 0.3, gamma: 0.2, priority: "Authority + trust",           brandArchetype: "Trust" },
  "Education — Professional Certification":     { alpha: 0.5, beta: 0.3, gamma: 0.2, priority: "Authority + credibility",     brandArchetype: "Trust" },
  // Real Estate
  "Real Estate — Residential Agent":            { alpha: 0.5, beta: 0.3, gamma: 0.2, priority: "Community trust",             brandArchetype: "Trust" },
  "Real Estate — Property Developer":           { alpha: 0.5, beta: 0.3, gamma: 0.2, priority: "Aspiration + authority",      brandArchetype: "Trust" },
  "Real Estate — Commercial / Investment":      { alpha: 0.5, beta: 0.3, gamma: 0.2, priority: "Trust + stability",           brandArchetype: "Trust" },
  "Real Estate — Property Management":          { alpha: 0.5, beta: 0.3, gamma: 0.2, priority: "Trust + reliability",         brandArchetype: "Trust" },
  // Automotive (Trust-leaning)
  "Automotive — Dealership / Sales":            { alpha: 0.5, beta: 0.3, gamma: 0.2, priority: "Trust + aspiration",          brandArchetype: "Trust" },
  "Automotive — Repair / Service":              { alpha: 0.5, beta: 0.3, gamma: 0.2, priority: "Trust + reliability",         brandArchetype: "Trust" },

  // ── COMMUNITY BRANDS ─────────────────────────────────────────────────────
  // Fitness & Sports
  "Fitness — Local Gym / Studio":               { alpha: 0.5, beta: 0.3, gamma: 0.2, priority: "Community identity",          brandArchetype: "Community" },
  "Fitness — Equipment / Apparel":              { alpha: 0.5, beta: 0.3, gamma: 0.2, priority: "Authority + momentum",         brandArchetype: "Community" },
  "Fitness — Online Training / App":            { alpha: 0.5, beta: 0.3, gamma: 0.2, priority: "Community + authority",        brandArchetype: "Community" },
  "Sports — Youth / Amateur Club":              { alpha: 0.5, beta: 0.3, gamma: 0.2, priority: "Community values",             brandArchetype: "Community" },
  "Sports — Professional Team / League":        { alpha: 0.5, beta: 0.3, gamma: 0.2, priority: "Community identity",          brandArchetype: "Community" },
  "Sports — Outdoor / Adventure":               { alpha: 0.5, beta: 0.3, gamma: 0.2, priority: "Lifestyle alignment",          brandArchetype: "Community" },
  // Retail (Community-leaning)
  "Retail — Local Boutique":                    { alpha: 0.5, beta: 0.3, gamma: 0.2, priority: "Community identity",          brandArchetype: "Community" },
  "Retail — Specialty / Niche Retail":          { alpha: 0.5, beta: 0.3, gamma: 0.2, priority: "Community fit",               brandArchetype: "Community" },
  "Retail — Thrift / Vintage":                  { alpha: 0.5, beta: 0.3, gamma: 0.2, priority: "Cultural identity",           brandArchetype: "Community" },
  // Beauty (Community-leaning)
  "Beauty — Skincare":                          { alpha: 0.5, beta: 0.3, gamma: 0.2, priority: "Trust + value alignment",      brandArchetype: "Community" },
  "Beauty — Hair Care":                         { alpha: 0.5, beta: 0.3, gamma: 0.2, priority: "Community authority",          brandArchetype: "Community" },
  "Beauty — Salon / Local Service":             { alpha: 0.5, beta: 0.3, gamma: 0.2, priority: "Local trust",                 brandArchetype: "Community" },
  "Beauty — Natural / Clean Beauty":            { alpha: 0.5, beta: 0.3, gamma: 0.2, priority: "Values alignment",            brandArchetype: "Community" },
  "Beauty — Men's Grooming":                    { alpha: 0.5, beta: 0.3, gamma: 0.2, priority: "Community identity",          brandArchetype: "Community" },
  // Food & Beverage (Community-leaning)
  "F&B — Specialty Coffee / Café":              { alpha: 0.5, beta: 0.3, gamma: 0.2, priority: "Lifestyle alignment",          brandArchetype: "Community" },
  "F&B — Health Food / Organic":                { alpha: 0.5, beta: 0.3, gamma: 0.2, priority: "Value alignment",             brandArchetype: "Community" },
  "F&B — Farmers Market / Local Produce":       { alpha: 0.5, beta: 0.3, gamma: 0.2, priority: "Community + values",          brandArchetype: "Community" },
  "F&B — Specialty / Ethnic Grocery":           { alpha: 0.5, beta: 0.3, gamma: 0.2, priority: "Cultural identity",           brandArchetype: "Community" },
  // Home & Lifestyle (Community-leaning)
  "Home — Interior Design / Décor":             { alpha: 0.5, beta: 0.3, gamma: 0.2, priority: "Aesthetic alignment",          brandArchetype: "Community" },
  "Home — Cleaning / Household Products":       { alpha: 0.5, beta: 0.3, gamma: 0.2, priority: "Relatability + trust",         brandArchetype: "Community" },
  "Home — Smart Home / Technology":             { alpha: 0.5, beta: 0.3, gamma: 0.2, priority: "Innovation + trust",           brandArchetype: "Community" },
  // Pet
  "Pet — Products / Accessories":               { alpha: 0.5, beta: 0.3, gamma: 0.2, priority: "Community fit",               brandArchetype: "Community" },
  "Pet — Veterinary / Local Service":           { alpha: 0.6, beta: 0.2, gamma: 0.2, priority: "Trust + safety",              brandArchetype: "Trust" },
  "Pet — Food / Nutrition":                     { alpha: 0.5, beta: 0.3, gamma: 0.2, priority: "Trust + community",           brandArchetype: "Community" },
  // Coaching & Wellness
  "Coaching — Business / Life Coach":           { alpha: 0.5, beta: 0.3, gamma: 0.2, priority: "Value + authority",           brandArchetype: "Community" },
  "Coaching — Nutrition / Dietitian":           { alpha: 0.5, beta: 0.3, gamma: 0.2, priority: "Authority + community",        brandArchetype: "Community" },
  "Coaching — Relationship / Dating":           { alpha: 0.5, beta: 0.3, gamma: 0.2, priority: "Trust + identity",            brandArchetype: "Community" },
  // Travel & Hospitality (Community-leaning)
  "Travel — Boutique Hotel / B&B":              { alpha: 0.5, beta: 0.3, gamma: 0.2, priority: "Aesthetic alignment",          brandArchetype: "Community" },
  "Travel — Local Tourism / Experience":        { alpha: 0.5, beta: 0.3, gamma: 0.2, priority: "Lifestyle fit",               brandArchetype: "Community" },
  "Travel — Eco / Sustainable Tourism":         { alpha: 0.5, beta: 0.3, gamma: 0.2, priority: "Values alignment",            brandArchetype: "Community" },
  // Fashion (Community-leaning)
  "Fashion — Heritage / Luxury":                { alpha: 0.6, beta: 0.2, gamma: 0.2, priority: "Semantic purity",             brandArchetype: "Community" },
  "Fashion — Accessible / Mid-Market":          { alpha: 0.5, beta: 0.3, gamma: 0.2, priority: "Balanced reach",              brandArchetype: "Community" },
  "Fashion — Sustainable / Ethical":            { alpha: 0.5, beta: 0.3, gamma: 0.2, priority: "Values alignment",            brandArchetype: "Community" },
  ...
  // Nonprofit & Cause
  "Nonprofit — Cause Marketing":                { alpha: 0.5, beta: 0.3, gamma: 0.2, priority: "Values alignment",            brandArchetype: "Community" },
  "Nonprofit — Community Organisation":         { alpha: 0.5, beta: 0.3, gamma: 0.2, priority: "Community identity",          brandArchetype: "Community" },
  "Government / Public Sector":                 { alpha: 0.5, beta: 0.3, gamma: 0.2, priority: "Trust + authority",           brandArchetype: "Trust" },
  // Restaurant (Community-leaning)
  "Restaurant — Casual Dining":                 { alpha: 0.5, beta: 0.3, gamma: 0.2, priority: "Community trust",             brandArchetype: "Community" },
  "Restaurant — Fine Dining / Experiential":    { alpha: 0.6, beta: 0.2, gamma: 0.2, priority: "Semantic purity",             brandArchetype: "Community" },
  "Restaurant — Ethnic / Cultural":             { alpha: 0.6, beta: 0.2, gamma: 0.2, priority: "Cultural identity",           brandArchetype: "Community" },
  "Restaurant — Brunch / Café Culture":         { alpha: 0.5, beta: 0.3, gamma: 0.2, priority: "Lifestyle alignment",          brandArchetype: "Community" },
  "Restaurant — Food Truck / Pop-Up":           { alpha: 0.5, beta: 0.3, gamma: 0.2, priority: "Culture + momentum",           brandArchetype: "Momentum" },

  // ── MOMENTUM BRANDS ──────────────────────────────────────────────────────
  // Beauty (Momentum-leaning)
  "Beauty — Makeup / Color":                    { alpha: 0.5, beta: 0.3, gamma: 0.2, priority: "Trend currency",              brandArchetype: "Momentum" },
  "Beauty — Fragrance / Luxury Beauty":         { alpha: 0.5, beta: 0.3, gamma: 0.2, priority: "Aspiration + momentum",        brandArchetype: "Momentum" },
  "Beauty — Nail / Body Art":                   { alpha: 0.5, beta: 0.3, gamma: 0.2, priority: "Trend currency",              brandArchetype: "Momentum" },
  // Retail (Momentum-leaning)
  "Retail — E-Commerce / DTC Product":          { alpha: 0.5, beta: 0.3, gamma: 0.2, priority: "Conversion + reach",          brandArchetype: "Momentum" },
  "Retail — Seasonal / Holiday Campaign":       { alpha: 0.5, beta: 0.3, gamma: 0.2, priority: "Maximum pulse",               brandArchetype: "Momentum" },
  "Retail — Flash Sale / Discount":             { alpha: 0.5, beta: 0.3, gamma: 0.2, priority: "Maximum pulse",               brandArchetype: "Momentum" },
  // Food & Beverage (Momentum-leaning)
  "F&B — Craft Beverage / Alcohol":             { alpha: 0.5, beta: 0.3, gamma: 0.2, priority: "Culture + momentum",           brandArchetype: "Momentum" },
  "F&B — Packaged Food / CPG":                  { alpha: 0.5, beta: 0.3, gamma: 0.2, priority: "Reach + relevance",           brandArchetype: "Momentum" },
  "F&B — Energy Drink / Supplement":            { alpha: 0.5, beta: 0.3, gamma: 0.2, priority: "Viral momentum",              brandArchetype: "Momentum" },
  "F&B — Food Delivery / Ghost Kitchen":        { alpha: 0.5, beta: 0.3, gamma: 0.2, priority: "Reach + relevance",           brandArchetype: "Momentum" },
  "F&B — Snack / Confectionery":                { alpha: 0.5, beta: 0.3, gamma: 0.2, priority: "Trend currency",              brandArchetype: "Momentum" },
  // Restaurant (Momentum-leaning)
  "Restaurant — QSR / Fast Food":               { alpha: 0.5, beta: 0.3, gamma: 0.2, priority: "Viral momentum",              brandArchetype: "Momentum" },
  "Restaurant — QSR / Limited-Time Activation": { alpha: 0.5, beta: 0.3, gamma: 0.2, priority: "Maximum pulse",               brandArchetype: "Momentum" },
  // Fashion (Momentum-leaning)
  "Fashion — Trend-First / Streetwear":         { alpha: 0.5, beta: 0.3, gamma: 0.2, priority: "Cultural momentum",           brandArchetype: "Momentum" },
  "Fashion — Fast Fashion":                     { alpha: 0.5, beta: 0.3, gamma: 0.2, priority: "Maximum pulse",               brandArchetype: "Momentum" },
